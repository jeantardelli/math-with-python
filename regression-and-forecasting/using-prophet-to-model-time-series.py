"""
The Prophet library is designed to automatically model time series data quickly,
without the need for input from the user, and make predictions into the future.

This module illustrates how to use Prophet to produce forecasts from a sample
time series.
"""
import pandas as pd
