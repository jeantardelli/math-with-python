"""
This module defines a simple class that represents a polynomial and write
methods for this class to perform differentiation and integration.
"""
class Polynomial:
...
p = Polynomial([1, -2, 1])
print(p.differentiate())       # Polynomial([-2, 2])
print(p.integrate(constant=1)) # Polynomial([1.0, 1.0, -1.0, 0.3333333333333])
